...
write-out sentence class `BigSentenceCodes` (`Framework/Emission/WriteOut.lean`): a `PolySegStream`
...
`BigSentenceCodes.bigAnd` in `Framework/Emission/WriteOut.lean` reuses this parse fact verbatim.) -/
