...
paper's is. The measure is `dSize` (`Framework/Theory/DerivationSize.lean`, `dd:symbolcount`; the
...
This is the first-order counterpart of `Framework/Criterion.lean`'s propositional
