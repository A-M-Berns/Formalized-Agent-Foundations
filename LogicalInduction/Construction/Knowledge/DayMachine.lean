...
(`Framework/Emission/CodeSource.lean`).  This module supplies the reusable day-varying witness for
...
`Framework/Emission/Computable.lean` produce.  Feeding that stream through the base-16 write-out
...
(`Construction/Knowledge/Endpoints.lean`) are built this way.
