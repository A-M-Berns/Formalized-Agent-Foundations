...
of `Construction/Paper/FirstOrder.lean`, and assembles the deductive process of the single
paper-facing market.  The theorem process is fixed by the arithmetic theory alone: it dovetails over
...
Consumed by `Construction/Paper/Market.lean`, `Construction/Knowledge/Endpoints.lean`,
