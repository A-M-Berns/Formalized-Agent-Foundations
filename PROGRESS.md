...
| M4 | Affine master + reusable LUV lift; close expectation/Self-Trust statements | **in progress (2026-07-13)** — the affine master is complete and axiom-clean. `AffineCombination.PolySequence` exposes polynomial term boundaries, coefficient streams, sentence codes, rank legality, and closed denotation; it uniformly emits cross-time prices, magnitudes, launch risks, gradual occupancies, sale fractions, and the complete gradual trader family. `EfficientlyEmulatable.of_polySeg`, finite-prefix family/feature/occupancy gates, and the zero-size-or-eventually-closed continuous budget theorem make eventual future-price hypotheses sufficient. `PolySequence.noPreemptiveUnderpricing`, its certified pointwise-negation dual, `noPreemptiveGaps`, and `PolySequence.affpolymax` now prove the operational and final liminf/limsup forms. **Audit correction:** polynomial maturity cannot be derived from merely partial-recursive market/process certificates; the continuous route avoids that false gate. Remaining M4 work is the reusable LUV affine lift and the seven expectation/Self-Trust statements. |
