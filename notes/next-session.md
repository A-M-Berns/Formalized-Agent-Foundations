...
- `M7-STRICT-SEPARATORS` — **DEFECTIVE AS STATED (kernel-checked, 2026-07-27)**:
  ...
  `M7-STRICT-SEPARATORS`'s interface was redesigned on 2026-07-27 (the old nested-prefix
  shape is provably uninhabitable — `no_ce_null_prefix_family`).  All fields but
  `mass_class_tendsto_zero` are now constructed; see Tranche S above for the three named
  residual inputs.
