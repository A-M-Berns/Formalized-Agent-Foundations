...
* `code_uniq`'s `rfind` case — object-level exclusivity of the two quotation fibers at
  `theoremDP_hworld`'s tag 5 — the quotation-negation fiber, numbered 7 until the T8/8
  retirement (2026-08-31) deleted the two dead inconsistency/consistency atoms and renumbered
  the event space gapless `0`–`5`; earlier editions of this file called it tag 7. This is the
  **price of avoiding Σ₁-soundness there**. The
